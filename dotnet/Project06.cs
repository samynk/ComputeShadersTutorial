...
namespace ComputeShaderTutorial
{
    ...
    class Project06:ComputeWindow
    {
        ...
        public Project06(String title, int w, int h):base(title,w,h)
        {
            ...
            m_SphereRayTracer = new ComputeShader("Resources/computeshaders/raytracer1/SphereRayTracer.glsl");
